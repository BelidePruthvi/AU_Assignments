...
public class PersonServiceImplProxy implements soap.PersonServiceImpl {
  private String _endpoint = null;
  private soap.PersonServiceImpl personServiceImpl = null;
  ...
  private void _initPersonServiceImplProxy() {
    try {
      personServiceImpl = (new soap.PersonServiceImplServiceLocator()).getPersonServiceImpl();
  ...
  public soap.PersonServiceImpl getPersonServiceImpl() {
    if (personServiceImpl == null)
      _initPersonServiceImplProxy();
