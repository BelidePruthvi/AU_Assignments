...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements soap.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8080/soap/services/PersonServiceImpl";
    ...
    public soap.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soap.PersonServiceImplSoapBindingStub _stub = new soap.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soap.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                soap.PersonServiceImplSoapBindingStub _stub = new soap.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap", "PersonServiceImpl"));
        }
