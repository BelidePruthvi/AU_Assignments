...
case 31:
        ...
        soap.Person getPerson31mtemp = samplePersonServiceImplProxyid.getPerson(id_6idTemp);
...
case 42:
        gotMethod = true;
        soap.Person[] getAllPersons42mtemp = samplePersonServiceImplProxyid.getAllPersons();
